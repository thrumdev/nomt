...
impl Test {
    ...
    pub fn new_with_params(
        ...
        let session = nomt
            .begin_session(SessionParams::default().with_witness_mode(WitnessMode::read_write()));
        Self {
            nomt,
    ...
    pub fn commit(&mut self) -> (Node, Witness, WitnessedOperations) {
        ...
        self.session =
            Some(self.nomt.begin_session(
                SessionParams::default().with_witness_mode(WitnessMode::read_write()),
            ));
    ...
    pub fn start_overlay_session<'a>(&mut self, ancestors: impl IntoIterator<Item = &'a Overlay>) {
        ...
        let params = SessionParams::default()
            .with_witness_mode(WitnessMode::read_write())
            .with_overlay(ancestors)
            .unwrap();
