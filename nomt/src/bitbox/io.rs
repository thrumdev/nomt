...
use crate::bitbox::store::{Page, PAGE_SIZE};
...
pub fn start_io_worker(
    ...
    let (command_tx, command_rx) = crossbeam::channel::bounded(MAX_IN_FLIGHT * 2);
...
impl Stats {
    ...
    fn log(&mut self) {
        const LOG_DURATION: Duration = Duration::from_millis(10000);
